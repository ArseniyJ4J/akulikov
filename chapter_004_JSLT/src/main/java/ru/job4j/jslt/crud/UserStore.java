...
//            ps.close();
            result = true;
            LOGGER.info(String.format("User create: %s", user.toString()));
...
//            ps.close();
            result = true;
            LOGGER.info(String.format("User update: %s", user.toString()));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return result;
    ...
    public void deleteUser(String login) {
        try (PreparedStatement prs = this.ps) {
            ...
            connection.commit();
//            ps.close();
            LOGGER.info(String.format("User deleted: %s", login));
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
